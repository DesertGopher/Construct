...
class NewsList(APIView):
    ...
    @swagger_auto_schema(
        operation_id="NewsList", operation_summary="Создание новости", tags=["Новости"]
    )
    @exception_handler("Новость")
    def post(self, request):
        ...
        serializer.save()
        return Response(
            {"data": serializer.data, "message": "Новость успешно добавлен."}
        )
...
class NewsDetail(APIView):
    ...
    def put(self, request, id):
        ...
        serializer.save()
        return Response(
            {"status": True, "message": "Запись о новости успешно изменена."}
        )
...
class UserDetail(APIView):
    ...
    def put(self, request, id):
        ...
        serializer.save()
        return Response(
            {"status": True, "message": "Запись о пользователе успешно изменена."}
        )
...
class ProductDetail(APIView):
    ...
    def put(self, request, id):
        ...
        serializer.save()
        return Response(
            {"status": True, "message": "Запись о товаре успешно изменена."}
        )
...
class CategoryProducts(APIView):
    ...
    def get(self, request, filter):
        ...
        data = Product.objects.filter(category_class=filter, is_active=True).order_by(
            "-is_stock"
        )
        if not data:
            raise EmptyResultSet
