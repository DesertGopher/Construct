from api.models import Address, District, News, Product, Profile, Support
...
class ProfileForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["profile_status"].widget = forms.Textarea(
            attrs={
                "placeholder": "Опишите себя в двух словах",
                "cols": 8,
                "rows": 1,
                "class": "form-control",
            }
        ...
        self.fields["website"].widget = forms.Textarea(
            attrs={
                "placeholder": "Оставьте ссылку на Ваш контакт (социальная сеть или вебсайт)",
                "cols": 8,
                "rows": 1,
                "class": "form-control",
            }
...
class AddAddress(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["fact_address"].widget = forms.Textarea(
            attrs={
...
class UserUpdate(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["first_name"].widget = forms.Textarea(
            attrs={"placeholder": "Имя", "cols": 8, "rows": 1, "class": "form-control"}
        )
        self.fields["last_name"].help_text = ""
        self.fields["last_name"].label = ""
        self.fields["last_name"].widget = forms.Textarea(
            attrs={
                "placeholder": "Фамилия",
                "cols": 8,
                "rows": 1,
        ...
        self.fields["email"].widget = forms.Textarea(
            attrs={
...
class WriteSupport(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["client_mail"].widget = forms.Textarea(
            attrs={
        ...
        self.fields["appeal"].widget = forms.Textarea(
            attrs={
