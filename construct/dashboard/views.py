...
def user_order_edit(request, order_id):
    if request.user.is_staff:
        ...
        message = 'У вас нет прав редактирования заказа'
        return render(request, 'dashboard/403.html', {'message': message})
...
def user_permissions(request):
    if request.user.is_superuser:
        ...
        message = 'Редактировать права доступа может только администратор.'
        return render(request, 'dashboard/403.html', {'message': message})
...
def news_edit(request, news_id):
    if request.user.is_staff:
        ...
        message = 'У вас нет прав редактирования новостей'
        return render(request, 'dashboard/403.html', {'message': message})
...
def product_edit(request, product_id):
    if request.user.is_staff:
        ...
        message = 'У вас нет прав редактирования продукта'
        return render(request, 'dashboard/403.html', {'message': message})
...
def create_news(request):
    if request.user.is_staff:
        ...
        message = 'У вас нет прав создания новостей'
        return render(request, 'dashboard/403.html', {'message': message})
