...
class EncodeForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["length"].widget = forms.TextInput(
            attrs={"placeholder": "Длина профиля"}
        )
        self.fields["project_name"].label = ""
        self.fields["project_name"].widget = forms.TextInput(
            attrs={"placeholder": "Проект"}
        )
        self.fields["element_name"].label = ""
        self.fields["element_name"].widget = forms.TextInput(
            attrs={"placeholder": "Имя элемента"}
        )
...
class CreateTemplate(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["checker"].widget = forms.Textarea(
            attrs={
                "placeholder": "Проверил",
                "cols": 8,
                "rows": 1,
                "class": "form-control",
            }
        ...
        self.fields["company"].widget = forms.Textarea(
            attrs={
        ...
        self.fields["object"].widget = forms.Textarea(
            attrs={
                "placeholder": "Объект",
                "cols": 8,
                "rows": 5,
        ...
        self.fields["project"].widget = forms.Textarea(
            attrs={
                "placeholder": "Проект",
                "cols": 8,
                "rows": 2,
...
class PlatePDF(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["schema"].widget = forms.TextInput(
            attrs={"placeholder": "Имя элемента"}
        )
        self.fields["position"].label = ""
        self.fields["position"].widget = forms.TextInput(
            attrs={"placeholder": "Позиция детали"}
        )
        self.fields["name"].label = ""
        self.fields["name"].widget = forms.TextInput(
            attrs={"placeholder": "Обозначение"}
        )
...
class SettingPlateForm(forms.Form):
    plate = forms.ChoiceField(choices=_PLATES_CHOICES, label="Выберите форму пластины")
...
class SquarePlate(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["side"].widget = forms.TextInput(
            attrs={"placeholder": "Длина стороны A, мм"}
        )
        self.fields["width"].label = "Толщина"
        self.fields["width"].widget = forms.TextInput(
            attrs={"placeholder": "Толщина металла, мм"}
        )
...
class TrapezoidPlate(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["side1"].widget = forms.TextInput(
            attrs={"placeholder": "Длина стороны A, мм"}
        )
        self.fields["side2"].label = "B"
        self.fields["side2"].widget = forms.TextInput(
            attrs={"placeholder": "Длина стороны B, мм"}
        )
        self.fields["slice"].label = "C"
        self.fields["slice"].widget = forms.TextInput(
            attrs={"placeholder": "Длина среза C, мм"}
        )
        self.fields["width"].label = "Толщина"
        self.fields["width"].widget = forms.TextInput(
            attrs={"placeholder": "Толщина металла, мм"}
...
class Angle(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["side3"].widget = forms.TextInput(
            attrs={"placeholder": "Длина стороны C, мм"}
        )
        self.fields["width"].label = "Толщина"
        self.fields["width"].widget = forms.TextInput(
            attrs={"placeholder": "Толщина металла, мм"}
